            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Formulario</a>
                        </li>
                        <li>
...
?>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <p>Muchas gracias <b><?php echo $nombre ; echo $apellido?></b></p>  
      <p>La información ha sido registrada:</p>
      <p>
        Fecha de nacimiento: <b><?php echo date("Y-m-d"); ?></b>
      </p>
      <p>
        Tu sexo es: <b><?php if ($sexo == 'm') {
                                echo "Masculino";
                              } elseif ($sexo == 'f') {
                                 echo "Femenino";
                              } else {
      ...
      <p>
        Areas de interés: <b><?php echo $ciencia?></b>
                            ,<b><?php echo $deportes?></b> 
                            ,<b><?php echo $pintura?></b>
                           ,<b><?php echo $video?></b>
      </p>
      <p>
        Página Personal <b><?php echo $direccionweb; ?></b>
      </p>
      <p>
        Correo Electrónico <b><?php echo $correo; ?></b>
      </p>
      <p>
        Color favorito <b><?php echo $colors; ?></b>
      </p>
